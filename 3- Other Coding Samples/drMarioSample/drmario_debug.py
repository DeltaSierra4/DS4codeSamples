...
DEBUG_PILLS = [("yellow", "yellow"), ("yellow", "blue"), ("blue", "blue")]
...
class Board:
    ...
    def spawn_viruses(self, count):
        self.set(4, 15, {"kind": "virus", "color": "blue"}) # DEBUG LINE
        #self.set(2, 15, {"kind": "virus", "color": "blue"}) # DEBUG LINE
        #self.set(3, 15, {"kind": "virus", "color": "blue"}) # DEBUG LINE
        return
...
class Game:
    def __init__(self):
        ...
        # active capsule
        self.active = None
        self.next_capsule_colors = DEBUG_PILLS[0] #(random_color_name(), random_color_name())
    ...
    def spawn_new_capsule(self):
        ...
        # prepare next
        if self.debug_pill > 2:
            self.next_capsule_colors = (random_color_name(), random_color_name())
        else:
            self.next_capsule_colors = DEBUG_PILLS[self.debug_pill]
            self.debug_pill += 1
